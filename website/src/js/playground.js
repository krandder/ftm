...
parameter_meanings['use_lognormal_task_distribution'] = 'If enabled, task thresholds are generated from a lognormal distribution: the full automation requirement is treated as the 99th percentile task threshold, the 20th percentile is pinned by the FLOP gap, and the task grid is increased to 10,000 buckets.';
parameter_justifications['use_lognormal_task_distribution'] = 'Experimental alternative to the hardcoded FTM task quantile curve; useful for inspecting 99%-99.9%-100% tail behavior.';
